...
class Config:
    def __init__(self, config_path=None):
        self.config = {
            "openai_api_key": "YOUR_OPENAI_API_KEY_HERE",  # Set your OpenAI API key here
            "model": "gpt-4o-mini",
            "graph_path": "quantum_unified_graph.pkl",
            "textual_embeddings_path": "textual_embeddings.pkl",
            "neural_embeddings_path": "quantum_combined_embeddings.pkl",
            "model_path": "quantum_unified_model.pt",
            "community_profiles_path": "quantum_community_profiles.json",
            "metapath_schemas_path": "quantum_metapath_schemas.json",
